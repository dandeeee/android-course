...
import static com.examples.ContentProviderDemo.Contstants.*;
...
public class CarContentProvier extends ContentProvider {
	...
	static {
		matcher.addURI(AUTHORITY, "Person", MATCHER_CODE_PERSON);
		matcher.addURI(AUTHORITY, "Car", MATCHER_CODE_CAR);
	}
