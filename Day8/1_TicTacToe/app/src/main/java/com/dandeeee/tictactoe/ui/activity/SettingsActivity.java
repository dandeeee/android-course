...
public class SettingsActivity extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditTextPreference victoryMessagePref = (EditTextPreference) findPreference(Constants.VICTORY_MESSAGE_PREFERENCE_KEY);
        ...
        boardColorPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                new ColorPickerDialog(SettingsActivity.this, SettingsActivity.this, color).show();
                return true;
            }
        });
