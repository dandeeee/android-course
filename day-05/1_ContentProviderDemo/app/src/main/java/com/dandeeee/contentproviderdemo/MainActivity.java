...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonInsertCar = (Button) findViewById(R.id.buttonInsert);
        buttonInsertCar.setOnClickListener(this);
        
        buttonQueryCar = (Button) findViewById(R.id.buttonQuery);
        buttonQueryCar.setOnClickListener(this);
